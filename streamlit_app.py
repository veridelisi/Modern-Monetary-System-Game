...
SCENARIOS = [
    ...
    },
    {
        ...
        "insight": "Every bank creates money independently. Money supply increased again — and we haven't moved a single coin or bill. Bank Y wrote <strong>two entries simultaneously</strong>: a <strong>loan</strong> on its asset side and a <strong>deposit</strong> on its liability side — both created from nothing at the same moment. Customer C now has brand new purchasing power.Pure accounting.",
        "tag": "💚 Money Created", "tag_type": "green",
        "choice_type": "loan",
        "choice_opts": LOAN_OPTS,
    ...
    },
    {
        ...
        "insight": "Bank X didn't need Customer A's deposit to fund this loan. Banks are not intermediaries that move existing savings — they manufacture new purchasing power.Bank X wrote <strong>two entries simultaneously</strong>: a <strong>loan</strong> on its asset side and a <strong>deposit</strong> on its liability side — both created from nothing at the same moment. Customer B now has brand new purchasing power.",
        "tag": "💚 Money Created", "tag_type": "green",
        "choice_type": "loan",
        "choice_opts": LOAN_OPTS,
    ...
    },
    {
        ...
        "insight": "Since both Customer A and Customer B bank at Bank X, no money ever leaves the building. Bank X simply <strong>reduces Customer A's deposit and increases Customer B's deposit</strong> — a single internal ledger adjustment. No reserves move, no Central Bank is involved, nothing crosses between institutions. This is why same-bank transfers are instant and costless: it's just an accountant changing two numbers on the same spreadsheet.",
    ...
    },
    {
        ...
        "insight": "This is where reserves earn their role. Customer C banks at Bank Y, Customer A at Bank X — so Bank Y must transfer reserves to Bank X at the Central Bank to settle the payment. <strong>Customer C's deposit shrinks, Bank Y loses reserves. Customer A's deposit grows, Bank X gains reserves.</strong> The amount of money in the economy hasn't changed — it just crossed from one bank's ledger to another, with reserves acting as the settlement rail behind the scenes.",
        "tag": "➡️ Transfer Only", "tag_type": "blue",
        "choice_type": "transfer",
        "choice_opts": TRANSFER_OPTS,
    ...
    },
    {
        ...
        "insight": "Banks are converting reserves — which sit locked inside the Central Bank's ledger and <strong>never circulate in the public economy</strong> — into physical cash stored in their vaults. The cash is now in the bank's possession, but it hasn't reached anyone's hands yet. <strong>It does not count as M1 until a customer actually withdraws it.</strong> Total money supply is unchanged: one form of central bank money simply became another form, sitting in a different drawer.",
    ...
    },
    {
        ...
        "insight": "When Customer A withdraws cash, their <strong>bank deposit is destroyed</strong> — it disappears from Bank X's liability side forever. But in its place, <strong>physical cash appears in Customer A's hands</strong>, entering public circulation for the first time. One form of money vanishes, another form of equal value materialises. This is why M1 doesn't change: the deposit that was counted is gone, but the cash that replaced it is now counted instead. Bank X needed the vault cash from Step 8 to make this possible.",
        "tag": "➡️ Form Change Only", "tag_type": "blue",
        "choice_type": "cash",
